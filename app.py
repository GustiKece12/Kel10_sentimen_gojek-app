...
# Load dataset
df = pd.read_csv('data/gojek_reviews.csv')

# Title
st.title("Gojek App Review Sentiment Analysis")
st.markdown("Website ini mengklasifikasikan dan menganalisis ulasan pengguna Gojek berdasarkan sentimen: **positif**, **netral**, dan **negatif**. Hasil Kerja kelompok 10")
